...
import { Shield, Zap, DollarSign, UserX, Globe, Ghost, AlertTriangle, CheckCircle, Terminal } from 'lucide-react';
...
const iconMap: { [key: string]: any } = {
  Shield, Zap, DollarSign, UserX, Globe, Ghost, Terminal
};
...
const Services: React.FC = () => {
  ...
  if (loading) return <div className="text-[#00ff9d] font-mono">Loading services...</div>;
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex justify-between items-start">
                  <div className="p-3 bg-[#8b0000]/10 rounded-sm group-hover:bg-[#8b0000]/20 transition-colors">
                    <IconComponent className="w-6 h-6 text-[#8b0000]" />
                  </div>
